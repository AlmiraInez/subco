    ...
    <div class="card card-{{ config('configs.app_theme') }} card-outline" id="attendance-preview">
      <div class="card-header">
        ...
        <div class="pull-right card-tools">
          <a onclick="addImport()" class="btn btn-{{ config('configs.app_theme') }} text-white btn-sm" data-toggle="tooltip" title="Import data">
        ...
        <table class="table table-striped table-bordered" style="width:100%" id="table-item">
          <thead>
            <tr>
              ...
              <th width="100">Attendance In</th>
              <th width="100">Attendance Out</th>
...
<script type="text/javascript">
  ...
  function addImport(){
      ...
      $('#form-import').find($('input[name=month]')).val($('.select2#month').val());
      $('#form-import').find($('input[name=year]')).val($('.select2#year').val());
