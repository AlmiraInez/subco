...
@section('content')
<form id="form" action="{{ route('attendanceapproval.update',['id'=>$attendances->id]) }}" class="form-horizontal"
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Position" id="position" name="position"
                      readonly value="{{ $attendances->position }}">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Wokring Group Type" id="working_type"
                      name="working_type" readonly value="{{ $attendances->working_group }}">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Working Time" id="working_time"
                      name="working_time" value="{{ $attendances->description }}">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="col-lg-12">
        <div class="card card-{{ config('configs.app_theme') }} card-outline">
          <div class="card-header">
            ...
            <div class="pull-right card-tools">
              <button form="form" type="submit" class="btn btn-sm btn-{{ config('configs.app_theme')}} text-white"
                title="Add"><i class="fa fa-save"></i></button>
              <a href="#" onClick="backurl()" class="btn btn-sm btn-default" title="Back"><i
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Fisrt In" id="first_in" name="first_in" readonly
                    value="{{ $attendances->attendance_in }}">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Last Out" id="last_out" name="last_out" readonly
                    value="{{ $attendances->attendance_out }}">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Adj Working Time" id="adj_working_time"
                    name="adj_working_time" required value="{{ $attendances->adj_working_time }}">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Over Time" id="over_time" name="over_time"
                    readonly value="{{ $attendances->adj_over_time }}">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Adj Over Time</label>
                  <input type="text" class="form-control" placeholder="Adj Over Time" id="adj_over_time"
                    name="adj_over_time" required value="{{ $attendances->adj_over_time }}">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="note" name="note"
                    placeholder="Notes">{{ $attendances->note }}</textarea>
                </div>
              </div>
            </div>
          </div>
...
<div class="modal fade" id="add_history" tabindex="-1" role="dialog" aria-hidden="true" role="dialog"
  aria-hidden="true">
      ...
      <div class="overlay-wrapper">
        ...
        <form id="form_history" action="{{ route('attendanceapproval.store')}}" method="post">
            ...
            <div class="row">
              <div class="col-md-12" style="visibility: hidden; position: absolute;">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="attendance_id" name="attendance_id"
                    placeholder="Attendance ID" value="{{ $attendances->id }}" readonly>
                </div>
              </div>
              <div class="col-md-12" style="visibility: hidden; position: absolute;">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="employee_id" name="employee_id" placeholder="Employee ID"
                    value="{{ $attendances->employee_id }}" readonly>
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
          ...
          <div class="modal-footer">
            <button form="form_history" type="submit" class="btn btn-sm btn-{{ config('configs.app_theme')}} text-white"
              title="Add"><i class="fa fa-save"></i></button>
...
<div class="modal fade" id="edit_history" tabindex="-1" role="dialog" aria-hidden="true" role="dialog"
  aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="overlay-wrapper">
        ...
        <form id="form_edit_history" class="form-horizontal" method="post" autocomplete="off">
            ...
            <div class="row">
              <div class="col-md-12" style="visibility: hidden; position: absolute;">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="attendance_id_edit" name="attendance_id_edit"
                    placeholder="Attendance ID" value="{{ $attendances->id }}" readonly>
                </div>
              </div>
              <div class="col-md-12" style="visibility: hidden; position: absolute;">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="employee_id_edit" name="employee_id_edit" placeholder="Employee ID"
                    value="{{ $attendances->employee_id }}" readonly>
                </div>
              </div>
              <div class="col-md-12">
          ...
          <div class="modal-footer">
            <button form="form_edit_history" type="submit" class="btn btn-sm btn-{{ config('configs.app_theme')}} text-white"
              title="Add"><i class="fa fa-save"></i></button>
            <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Close</button>
          </div>
        </form>
