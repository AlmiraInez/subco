...
<form id="form" action="{{ route('question.update', ['id' =>$question->id]) }}" method="post" autocomplete="off">
    {{ csrf_field() }}
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="order" id="order" value="{{$question->order}}" placeholder="Urutan" required>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  {{-- <input type="text" class="form-control" name="type" value="Pertanyaan" readonly> --}}
                </div>
              </div>
            </div>
        </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="description" placeholder="Pertanyaan" value="{{$question->description}}" required>{{$question->description}}</textarea>
                </div>
              </div>
            </div>
          {{-- </form> --}}
            ...
            {{-- <form role="form"> --}}
                <table class="table table-bordered table-striped" id="table-department">
                    ...
                    <tbody>
                        ...
                        <td class="text-center"><input type="checkbox" name="department_status[{{$department->id}}]" @if($department->question_department_id) checked @endif></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
