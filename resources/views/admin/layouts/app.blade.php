    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-{{config('configs.app_theme')}} navbar-dark">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link text-dark" href="{{ route('admin.logout') }}" onclick="event.preventDefault();
        ...
        <aside class="main-sidebar sidebar-light-{{config('configs.app_theme')}} elevation-4">
            <!-- Brand Logo -->
            <a href="{{route('admin.dashboard.index')}}" class="brand-link navbar-{{config('configs.app_theme')}}">
            ...
            <div class="sidebar">
                ...
                <div class="profile-info">
                    ...
                    <div class="user-info">
                        <img src="{{asset('adminlte/images/user2-160x160.jpg')}}" class="img-circle elevation-2" alt="{{ Auth::guard('admin')->user()->name }}">
                        <h6>{{ Auth::guard('admin')->user()->name }}</h6>
                        <p>{{ Auth::guard('admin')->user()->roles()->first()->name }}</p>
                    </div>
                </div>
