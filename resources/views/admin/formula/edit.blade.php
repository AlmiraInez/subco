...
<form id="form" action="{{ route('formula.update', ['id'=>$formula->id]) }}" method="post" autocomplete="off">
    {{ csrf_field() }}
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name" id="name" value="{{$formula->name}}" placeholder="Nama" required>
                </div>
              </div>
              <div class="col-sm-6">
                {{--  --}}
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <select name="status" id="status" class="form-control select2" data-placeholder="Select Status">
                    <option value="1" @if ($formula->status == '1') selected @endif>Active</option>
                    <option value="0" @if ($formula->status == '0') selected @endif>Non Active</option>
                  </select>
                </div>
              </div>
            </div>
