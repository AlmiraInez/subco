  ...
  <div class="col-lg-12">
    <div class="card card-{{ config('configs.app_theme') }} card-outline">
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item"><a href="#max_off" class="nav-link" data-toggle="tab">Max Off</a></li>
      </ul>
      <div class="tab-content">
        ...
        <div class="tab-pane " id="max_off">
          <div class="card-header">
            <h3 class="card-title">List Max Off</h3>
          </div>
          <div class="card-body">
            {{-- DataTable List Max Off --}}
            <div class="col-sm-4">
              <label class="control-label" for="year">Period</label>
                <div class="input-group">
                    <select name="year" class="form-control select2" id="year"
                        ...
                        <option value="{{ $i }}" @if ($getyear==$i) selected @endif>
                            {{ $i }}</option>
                        @endfor
                    </select>
                </div>
            ...
            <br>
            <table class="table table-striped table-bordered datatable" id="table-max_off" style="width:100%">
              <thead>
                <tr>
                  <th class="text-center" width="5"> # </th>
                  <th width="100">Month</th>
                  <th width="200">Amount Day Off</th>
                </tr>
              </thead>
                @if ($countmaxoff > 0)
                        @php
                        ...
                        @foreach($maxoff as $row)
                          <tr>
                            ...
                            <td class="text-center align-middle">
                              <div class="form-group mb-0"><input type="number" placeholder="Amount Day Off" name="amount_day_off[]" class="form-control" value="{{ $row->amount_day_off }}"/></div>
                            </td>
                          </tr>
                        @endforeach
                @else
                      ...
                      @foreach ($arrMonths as $num => $name)
                          <tr>
                            ...
                            <td class="text-center align-middle">
                              <div class="form-group mb-0"><input type="number" placeholder="Amount Day Off" name="amount_day_off[]" class="form-control" value=""/></div>
                            </td>
                          </tr>
                      @endforeach
                @endif
