          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="description" id="description1" value="1"
                  checked>
                <label class="form-check-label" for="description1">&emsp;Paid Leave</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="description" id="description2" value="0">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("select[id=category]").on("change", function() { 
      if ($(this).val() === "1") {
        $("div[id=end_date]").fadeOut("fast").hide(); 
      } else { 
        $("div[id=end_date]").fadeIn("slow").show();
      } 
    });
