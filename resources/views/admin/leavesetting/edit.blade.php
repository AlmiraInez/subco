    ...
    <div class="col-lg-8">
      <div class="card card-{{ config('configs.app_theme') }} card-outline">
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <div class="form-check form-check-inline">
                <input class="form-check-input" @if ($leavesetting->description == 1)
                checked
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" @if ($leavesetting->description == 0)
                checked
          ...
          <div class="form-group row" id="type" style="display:none;">
            <label class="col-sm-2 col-xs-12 col-form-label" for="label_color">Type</label>
            <div class="col-sm-10">
              <select class="form-control select2" id="type" name="type">
                <option value="basicsalary" @if($leavesetting->type == "basicsalary") selected @endif >Basic Salary</option>
                <option value="nominal" @if($leavesetting->type == "nominal") selected @endif >Nominal</option>
              </select>
            </div>
          </div>
          <div class="form-group row" id="value-nominal" style="display: none">
            <label class="col-md-2 col-xs-12 control-label" for="value-nominal">Nominal</label>
            <div class="input-group col-sm-10 controls">
              <input type="text" class="form-control" id="nominal" name="nominal" placeholder="Nominal" value="{{$leavesetting->nominal}}"/>
            </div>
          </div>
        </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    $("select[id=type]").on("change", function() { 
      if ($(this).val() === "basicsalary") {
        $("div[id=value-nominal]").fadeOut("fast").hide(); 
      } else { 
        $("div[id=value-nominal]").fadeIn("slow").show();
      } 
    });
    $("[name=description]").change(function(){  // Whenever the radio buttons change
      $("#type").toggle($("[name=description]").index(this)!=1);  // Only keep the list open when it's the last option (First option = 0, Third option = 2)
    });
