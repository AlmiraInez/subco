            ...
            <div class="card-body card-profile text-center">
                ...
                <ul class="list-group list-group-unbordered">
                    ...
                    <li class="list-group-item d-flex">
                        ...
                        <b class="mr-auto">Coordinator</b> <span class="pull-right">Belum Ada Coordinator</span>
                        @else
                        <b class="mr-auto">Coordinator</b> <span class="pull-right">{{$employee->user->name}}</span>
                        @endif
                    </li>
                    <li class="list-group-item d-flex">
                        @if ($employee->resign_date == null)
                        <b class="mr-auto">End Contract Date</b> <span class="pull-right">Belum Ada Perjanjian Kontrak</span>
                        @else    
