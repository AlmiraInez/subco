		...
		<div class="card card-{{config('configs.app_theme')}} card-outline">
			...
			<div class="tab-content">
				...
				<div class="tab-pane active" id="personal">
					<form id="form" action="{{route('employees.update',['id'=>$employee->id])}}" class="form-horizontal"
						method="post" name="form_employee" autocomplete="off">
						{{ csrf_field() }}
						@method('PUT')
										...
										<div class="col-lg-8">
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<div class="form-group">
														<label>NIK</label>
														<input type="text" class="form-control" placeholder="NIK Bosung" name="nid"
															value="{{ $employee->nid}}">
													</div>
												</div>
											</div>
												...
												<div class="col-sm-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="department_id" id="department_id"
															data-placeholder="Select Department" required required>
													</div>
												</div>
												<div class="col-sm-6">
													<!-- text input -->
												...
												<div class="col-sm-6">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" name="workgroup_id" id="workgroup_id"
															data-placeholder="Select Workgroup" required>
													</div>
												</div>
												<div class="col-sm-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="grade_id" id="grade_id"
															data-placeholder="Select Grade" required>
													</div>
												</div>
											</div>
										</div>
												...
												<div class="col-sm-12">
													...
													<div class="form-group">
														...
														<div class="col-sm-12"
															...
															<input type="file" class="form-control" name="photo" id="picture" accept="image/*"
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="No.Ktp" name="nik"
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<div class="input-group">
														...
														<input type="text" required name="birth_date" class="form-control datepicker"
															id="birth_date" placeholder="Birthday"
															value="{{ date('d/m/Y',strtotime($employee->birth_date)) }}">
													</div>
												</div>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-sm-6">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder=" Biological Mother's Name"
											...
											<div class="col-sm-6">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="BPJS Tenaga Kerja"
														name="bpjs_tenaga_kerja" value="{{ $employee->bpjs_tenaga_kerja }}">
												</div>
											</div>
											<div class="col-sm-6">
												<!-- text input -->
										...
										<div class="row">
											<div class="col-sm-6">
												...
												<div class="form-group">
													...
													<input type="number" required class="form-control" placeholder="Phone No" name="phone"
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" required class="form-control" name="province_id" id="province_id"
											...
											<div class="col-sm-6">
												...
												<div class="form-group">
													...
													<input type="text" required class="form-control" name="region_id" id="region_id"
										...
										<div class="row">
											<div class="col-sm-6">
												...
												<div class="form-group">
													...
													<div class="row">
														<div class="col-sm-4">
															<input type="text" class="form-control" name="account_bank" placeholder="Bank"
																value="{{ $employee->account_bank }}">
														</div>
														<div class="col-sm-8">
										...
										<div class="row">
											<div class="col-sm-6">
												...
												<div class="form-group">
													...
													<input type="number" required class="form-control" placeholder="Emergency Contact No"
														name="emergency_contact_no" value="{{ $employee->emergency_contact_no }}">
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
													<label>Emergency Contact Name <b class="text-danger">*</b></label>
													<input type="text" required class="form-control" placeholder="Emergency Contact Name"
										...
										<div class="row">
											<div class="col-sm-6">
												...
												<div class="form-group">
													...
													<select name="working_time_type" id="working_time_type" class="form-control select2" readonly
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="working_time" id="working_time"
														data-placeholder="Pilih Working Time">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-sm-6">
												...
												<div class="form-group">
													...
													<input class="form-control" type="text" name="calendar_id" id="calendar_id" required
											...
											<div class="col-sm-12">
												<div class="form-group">
													...
													<textarea type="text" class="form-control" name="notes"
														placeholder="Notes">{{ $employee->notes }}</textarea>
												</div>
											</div>
											{{-- <div class="col-sm-12">
												<div class="form-group">
											...
											<div class="col-sm-12">
												<div class="form-group">
													...
													<div class="input-group">
														...
														<input type="text" name="join_date" class="form-control datepicker" id="join_date"
															placeholder="Join Date" value="{{ date('d/m/Y',strtotime($employee->join_date)) }}">
													</div>
												</div>
											</div>
											<div class="col-sm-12">
												<div class="form-group">
													...
													<div class="input-group">
														...
														<input type="text" name="resign_date" class="form-control datepicker" id="resign_date"
															placeholder="Resign Date"
															value="{{ $employee->resign_date?date('d/m/Y',strtotime($employee->resign_date)):'' }}">
													</div>
												</div>
											</div>
											<div class="col-sm-12">
												<div class="form-group">
													...
													<select id="coordinator" class="form-control select2" name="setup_user"
														data-placeholder="User" required>
														<option value="no" @if($employee->setup_user == 'no')selected @endif>No</option>
														<option value="yes" @if($employee->setup_user == 'yes')selected @endif>Yes</option>
													</select>
												</div>
											</div>
											<div class="col-sm-12" id="role-user" style="display:none;">
												<div class="form-group">
													<label>Role</label>
													<input type="text" class="form-control" id="role" name="role" data-placeholder="Select Role">
												</div>
											</div>
											<div class="col-sm-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="user_id"
														id="user_id" data-placeholder="Select Coordinator">
												</div>
											</div>
										</div>
									</div>
				...
				<div class="tab-pane" id="contract">
					<div class="card-header">
						...
						<div class="pull-right card-tools">
							<a href="#" class="btn btn-{{config('configs.app_theme')}} btn-sm text-white add_contract"
				...
				<div class="tab-pane" id="career">
					...
					<div class="card-header">
						...
						<div class="pull-right card-tools">
							<a href="#" class="btn btn-{{config('configs.app_theme')}} btn-sm text-white add_experience"
								data-toggle="tooltip" title="Tambah">
								<i class="fa fa-plus"></i>
							</a>
						</div>
				...
				<div class="tab-pane" id="education">
					<div class="card-header">
						...
						<div class="pull-right card-tools">
							<a href="#" class="btn btn-{{config('configs.app_theme')}} btn-sm text-white add_education"
								data-toggle="tooltip" title="Tambah">
								<i class="fa fa-plus"></i>
							</a>
						</div>
					...
					<div class="card-header">
						...
						<div class="pull-right card-tools">
							<a href="#" class="btn btn-{{config('configs.app_theme')}} btn-sm text-white add_training"
								data-toggle="tooltip" title="Tambah">
								<i class="fa fa-plus"></i>
							</a>
						</div>
				...
				<div class="tab-pane" id="insurance">
					<div class="card-header">
						...
						<div class="pull-right card-tools">
							<a href="#" class="btn btn-{{config('configs.app_theme')}} btn-sm text-white add_bpjs"
								data-toggle="tooltip" title="Tambah">
								<i class="fa fa-plus"></i>
							</a>
						</div>
					...
					<div class="card-header">
						...
						<div class="pull-right card-tools">
							<a href="#" class="btn btn-{{config('configs.app_theme')}} btn-sm text-white add_member"
								data-toggle="tooltip" title="Tambah">
								<i class="fa fa-plus"></i>
							</a>
						</div>
				...
				<div class="tab-pane" id="document">
					<div class="card-header">
						...
						<div class="pull-right card-tools">
							<a href="#" class="btn btn-{{config('configs.app_theme')}} btn-sm text-white add_document"
								data-toggle="tooltip" title="Tambah">
								<i class="fa fa-plus"></i>
							</a>
						</div>
							...
							<div class="col-3 col-sm-2">
								<div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist"
									...
									<a class="nav-link active" id="vert-tabs-home-tab" data-toggle="pill" href="#vert-tabs-home"
										role="tab" aria-controls="vert-tabs-home" aria-selected="true">Basic Salary</a>
									<a class="nav-link" id="vert-tabs-gross-tab" data-toggle="pill" href="#vert-tabs-gross" role="tab" aria-controls="vert-tabs-gross" aria-selected="true">Salary Report</a>
									<a class="nav-link" id="vert-tabs-profile-tab" data-toggle="pill" href="#vert-tabs-profile" role="tab"
										aria-controls="vert-tabs-profile" aria-selected="false">Allowance</a>
									@if (strpos($employee->department->path,'Driver') !== false)
									<a class="nav-link" id="driver-allowance-tab" data-toggle="pill" href="#tabs-driver-allowance"
										role="tab" aria-controls="vert-tabs-messages" aria-selected="false">Driver Allowance</a>
									@endif
									<a class="nav-link" id="vert-tabs-messages-tab" data-toggle="pill" href="#vert-tabs-messages"
										role="tab" aria-controls="vert-tabs-messages" aria-selected="false">Over Time</a>
									<a class="nav-link" id="vert-tabs-messages-tab" data-toggle="pill" href="#vert-tabs-penalti"
										role="tab" aria-controls="vert-tabs-messages" aria-selected="false">Potongan Absen</a>
								</div>
							</div>
								...
								<div class="tab-content" id="vert-tabs-tabContent">
									<div class="tab-pane text-left fade show active" id="vert-tabs-home" role="tabpanel"
										...
										<div class="card-header">
											...
											<div class="pull-right card-tools">
												<a href="#" class="btn btn-{{config('configs.app_theme')}} btn-sm text-white add_salary"
									...
									<div class="tab-pane fade" id="vert-tabs-gross" role="tabpanel" aria-labelledby="vert-tabs-gross-tab">
										<div class="card-header">
											<p class="card-title">Salary Report</p>
										</div>
										<div class="card-body">
										...
										<div class="card-header">
											<p class="card-title">Deduction</p>
										</div>
										<div class="card-body">
											<table class="table table-striped table-bordered" id="deduction-table" style="width: 100%">
											<thead>
												<tr>
												<th width="10">No</th>
												<th width="600">Description</th>
									...
									<div class="tab-pane fade" id="vert-tabs-profile" role="tabpanel"
										...
										<div class="card-header">
											...
											<div class="pull-right card-tools">
												<a href="#"
													class="btn btn-{{ config('configs.app_theme') }} btn-sm text-white add_allowance_data"
													data-toggle="tooltip" title="Tambah"><i class="fa fa-plus"></i></a>
												...
												<div class="row col-sm-11">
													...
													<div class="col-sm-2" style="padding-bottom:0;">
														<button type="button" onclick="generate()"
															class="btn btn-{{ config('configs.app_theme') }}">Generate</button>
													</div>
												</div>
											</div>
											<!-- <div class="form-group row">
									...
									<div class="tab-pane fade" id="tabs-driver-allowance" role="tabpanel"
										aria-labelledby="driver-allowance-tab">
										<div class="card-header">
									...
									<div class="tab-pane fade" id="vert-tabs-penalti" role="tabpanel"
										aria-labelledby="vert-tabs-messages-tab">
										<div class="card-header">
				...
				<div class="tab-pane" id="attendance">
					<form id="form_approval" action="{{ route('attendanceapproval.approve') }}" class="form-horizontal"
...
<!-- Edit Overtime Hour -->
<div class="modal fade" id="editovertime" tabindex="-1" role="dialog" aria-hidden="true" tabindex="-1" role="dialog"
	aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button form="form_overtime" type="submit" class="btn btn-sm btn-{{config('configs.app_theme')}} text-white"
					title="Simpan"><i class="fa fa-save"></i></button>
			</div>
			<div class="overlay d-none">
				<i class="fa fa-2x fa-sync-alt fa-spin"></i>
...
{{-- Modal Salary --}}
<div class="modal fade" id="add_salary" tabindex="-1" role="dialog" aria-hidden="true" tabindex="-1" role="dialog"
	aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<form id="form_salary" class="form-horizontal" autocomplete="off">
					<div class="row">
						...
						<div class="form-group col-md-12">
							...
							<input type="text" class="form-control" id="user_id" name="user_id" readonly placeholder="Update By"
								required>
						</div>
					</div>
				</form>
			...
			<div class="modal-footer">
				<button form="form_salary" type="submit" class="btn btn-sm btn-{{config('configs.app_theme')}} text-white"
					title="Simpan"><i class="fa fa-save"></i></button>
			</div>
			<div class="overlay d-none">
				<i class="fa fa-2x fa-sync-alt fa-spin"></i>
...
{{-- Modal Allowance --}}
<div class="modal fade" id="add_allowance" tabindex="-1" role="dialog" aria-hidden="true" tabindex="-1" role="dialog"
	aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
...
<div class="modal fade" id="view_allowance" tabindex="-1" role="dialog" aria-hidden="true" tabindex="-1" role="dialog"
	aria-hidden="true">
...
<div class="modal fade" id="view-driver-allowance" tabindex="-1" role="dialog" aria-hidden="true" tabindex="-1"
...
<div class="modal fade" id="view-detail-leave" tabindex="-1" role="dialog" aria-hidden="true" tabindex="-1"
	role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
...
<div class="modal fade" id="edit-leave-balance" tabindex="-1" role="dialog" aria-hidden="true" tabindex="-1"
	role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="form-edit-balance" action="{{ route('leave.quickupdate') }}" class="form-horizontal no-gutters"
					method="post" autocomplete="off">
					{{ csrf_field() }}
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="number" class="form-control" name="leave_balance" id="leave_balance" placeholder="Balance"
									value="">
							</div>
						</div>
					</div>
			...
			<div class="modal-footer">
				<button form="form-edit-balance" type="submit" class="btn btn-{{ config('configs.app_theme') }}"
					title="Apply"><i class="fa fa-save"></i></button>
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
			</div>
		</div>
	</div>
...
{{-- Modal Allowance Add --}}
<div class="modal fade" id="add_allowance_data" tabindex="-1" role="dialog" aria-hidden="true" tabindex="-1"
	role="dialog" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="allowance_id" name="allowance_id" placeholder="Allowance"
									required>
							</div>
							<div class="form-group">
			...
			<div class="modal-footer">
				<button form="form_allowance_data" type="submit"
...
{{-- Modal Training --}}
<div class="modal fade" id="add_training" tabindex="-1" role="dialog" aria-hidden="true" role="dialog"
	aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="overlay-wrapper">
				...
				<div class="modal-footer">
					<button form="form_training" type="submit" class="btn btn-sm btn-{{config('configs.app_theme')}} text-white"
						title="Simpan"><i class="fa fa-save"></i></button>
				</div>
				<div class="overlay d-none">
					<i class="fa fa-2x fa-sync-alt fa-spin"></i>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="overlay-wrapper">
					...
					<form id="form_document" class="form-horizontal" method="post" autocomplete="off">
						<div class="d-flex">
							...
							<div class="form-group col-sm-6">
								...
								<select id="category" name="category" class="form-control select2" data-placeholder="Choose Category"
									required>
									<option value=""></option>
				...
				<div class="modal-footer">
					<button form="form_document" type="submit" class="btn btn-sm btn-{{config('configs.app_theme')}} text-white"
						title="Simpan"><i class="fa fa-save"></i></button>
				</div>
				<div class="overlay d-none">
					<i class="fa fa-2x fa-sync-alt fa-spin"></i>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="overlay-wrapper">
				...
				<div class="modal-footer">
					<button form="form_career" type="submit" class="btn btn-sm btn-{{config('configs.app_theme')}} text-white"
						title="Simpan"><i class="fa fa-save"></i></button>
				</div>
				<div class="overlay d-none">
					<i class="fa fa-2x fa-sync-alt fa-spin"></i>
...
{{-- Modal Experience --}}
<div class="modal fade" id="add_experience" tabindex="-1" role="dialog" aria-hidden="true" role="dialog"
	aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="overlay-wrapper">
						...
						<div class="d-flex">
							<div class="form-group col-sm-6">
								...
								<input type="text" class="form-control" id="last_position" name="last_position"
									placeholder="Last Position" required>
							</div>
							<div class="form-group col-sm-6">
				...
				<div class="modal-footer">
					<button form="form_experience" type="submit" class="btn btn-sm btn-{{config('configs.app_theme')}} text-white"
						title="Simpan"><i class="fa fa-save"></i></button>
				</div>
				<div class="overlay d-none">
					<i class="fa fa-2x fa-sync-alt fa-spin"></i>
...
{{-- Modal Education --}}
<div class="modal fade" id="add_education" tabindex="-1" role="dialog" aria-hidden="true" role="dialog"
	aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="overlay-wrapper">
				...
				<div class="modal-footer">
					<button form="form_education" type="submit" class="btn btn-sm btn-{{config('configs.app_theme')}} text-white"
						title="Simpan"><i class="fa fa-save"></i></button>
				</div>
				<div class="overlay d-none">
					<i class="fa fa-2x fa-sync-alt fa-spin"></i>
...
{{-- Modal Contract --}}
<div class="modal fade" id="add_contract" tabindex="-1" role="dialog" aria-hidden="true" role="dialog"
	aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="overlay-wrapper">
				...
				<div class="modal-footer">
					<button form="form_contract" type="submit" class="btn btn-sm btn-{{config('configs.app_theme')}} text-white"
						title="Simpan"><i class="fa fa-save"></i></button>
				</div>
				<div class="overlay d-none">
					<i class="fa fa-2x fa-sync-alt fa-spin"></i>
...
<div class="modal fade" id="edit-shift" tabindex="-1" role="dialog" aria-hidden="true" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="form-shift" action="{{ route('attendanceapproval.quickupdate') }}" class="form-horizontal no-gutters"
					method="post" autocomplete="off">
					{{ csrf_field() }}
...
<div class="modal fade" id="edit-out" tabindex="-1" role="dialog" aria-hidden="true" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button form="form-out" type="submit" class="btn btn-{{ config('configs.app_theme') }}" title="Apply"><i
						class="fa fa-save"></i></button>
			</div>
		</div>
	</div>
...
<div class="modal fade" id="edit-worktime" tabindex="-1" role="dialog" aria-hidden="true" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="form-worktime" action="{{ route('attendanceapproval.quickupdate') }}"
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="number" class="form-control" name="working_time" id="working_time"
									placeholder="Working Time" value="0">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
			...
			<div class="modal-footer">
				<button form="form-worktime" type="submit" class="btn btn-{{ config('configs.app_theme') }}" title="Apply"><i
						class="fa fa-save"></i></button>
			</div>
		</div>
	</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="overlay-wrapper">
				...
				<div class="modal-footer">
					<button form="form_bpjs" type="submit" class="btn btn-sm btn-{{config('configs.app_theme')}} text-white"
						title="Simpan"><i class="fa fa-save"></i></button>
				</div>
				<div class="overlay d-none">
					<i class="fa fa-2x fa-sync-alt fa-spin"></i>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="overlay-wrapper">
				...
				<div class="modal-footer">
					<button form="form_member" type="submit" class="btn btn-sm btn-{{config('configs.app_theme')}} text-white"
						title="Simpan"><i class="fa fa-save"></i></button>
				</div>
				<div class="overlay d-none">
					<i class="fa fa-2x fa-sync-alt fa-spin"></i>
...
$("select[id=coordinator]").on("change", function() { 
	if ($(this).val() === "no") {
		$("div[id=role-user]").fadeOut("fast").hide(); 
	} else { 
		$("div[id=role-user]").fadeIn("slow").show();
	} 
});
$("#role").select2({
	ajax: {
...
@if($employee->role_id)
	$("div[id=role-user]").fadeIn("slow").show();
	$("#role").select2('data',{id:{{$employee->role_id}},text:'{{$employee->role->display_name}}'}).trigger('change');
@endif
...
$(document).ready(function(){
	...
	@if($employee->user_id)
		$("#user_id").select2('data',{id:{{$employee->user_id}},text:'{{$employee->user->name}}'}).trigger('change');
	@endif
	// Province
	$("#province_id").select2({
		ajax: {
	...
	dataTableDeduction = $('#deduction-table').DataTable({
		...
		ordering: false,
		ajax: {
		url: "{{route('salaryreportdetail.employeededuction')}}",
		type: "GET",
		data:function(data){
		data.employee_id = {{$employee->id}};
		data.month = $('select[name=month-gross]').val();
	...
	dataTableHistory = $('#table-history').DataTable( {
		...
		columns: [
			...
			{ data: "tanggal_masuk" },
			{ data: "allowance"},
			{ data: "value", render: $.fn.dataTable.render.number( '.', ',', 2, 'Rp. ' )}
		]
	});
		...
		columnDefs:[
			...
			{ render: function ( data, type, row ) {
				return `<div class="dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						<li><a class="dropdown-item editovertime" href="/leavereport/{id}/detail"><i class="fas fa-pencil-alt mr-2"></i> Detail</a></li>
					</ul>
					</div>`
			},targets: [4]
			}
