...
@section('title', 'Tambah Pesan Ruangan')
@section('stylesheets')
...
<li class="breadcrumb-item active">Tambah Pesan Ruangan</li>
@endpush
      ...
      <div class="col-lg-8">
        <div class="card card-{{ config('configs.app_theme') }} card-outline">
          <div class="card-header" style="height: 57px;">
            <h3 class="card-title">Tambah Pesan Ruangan</h3>
          </div>
          <div class="card-body">
            <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="category_id" id="category_id" placeholder="Pilih Kategori">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label>Ruangan <b class="text-danger">*</b></label>
                    <input type="text" class="form-control" name="room_id" id="room_id" placeholder="Pilih Ruangan">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="price" id="price" placeholder="Harga Ruangan" readonly="readonly">
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
