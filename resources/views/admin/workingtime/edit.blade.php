				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" value="" multiple="multiple" name="department[]" class="form-control select2" placeholder="Select Department" id="department">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label>Working Shift Start <b class="text-danger">*</b></label>
							<select name="working_time_start" id="working_time_start" class="form-control select2" data-placeholder="Select Working Start">
								<option value="{{ $workingtime->working_time_start }}" @if ($workingtime->working_time_start == "list") selected @endif>List</option>
								<option value="{{ $workingtime->working_time_start }}" @if ($workingtime->working_time_start == "checkin") selected @endif>Check In</option>
							</select>
						</div>
					</div>
				</div>
		...
		$( "#department" ).select2({
          ...
          success: function (result) {                  
           ...
           $.each(result.results, function(key, val){
			...
			data.push({ id:val.department_id,text:val.department_name });
