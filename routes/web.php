...
Route::get('/overtimescheme/approved', 'Admin\CronController@generateOvertimeApprove')->name('overtime.approved');
    ...
    Route::group(['middleware' => 'auth:admin'], function () {
        ...
        Route::group(['as' => 'admin.', 'namespace' => 'Admin'], function() {
            Route::group(['prefix' => 'dashboard', 'as' => 'dashboard.'], function() {
                ...
                Route::resource('inventory', 'Dashboard\InventoryController');
            ...
            Route::group(['prefix' => 'transaction', 'as' => 'transaction.', 'namespace' => 'Transaction'], function () {
                Route::get('/booking/read', 'BookingController@read')->name('booking.read');
                Route::get('/booking/{id}/addbooking', 'BookingController@addbooking')->name('booking.addbooking');
                Route::put('/booking/savebooking/{id}', 'BookingController@savebooking')->name('booking.savebooking');
                Route::get('/booking/readapproval', 'BookingController@read')->name('booking.readapproval');
                Route::get('/booking/approval', 'BookingController@indexapproval')->name('booking.indexapproval');
                Route::resource('booking', 'BookingController');
            });
            Route::group(['prefix' => 'transaction', 'as' => 'transaction.', 'namespace' => 'Transaction'], function () {
                Route::get('/approval/read', 'ApprovalController@read')->name('approval.read');
                Route::get('/approval/{id}/editapproval', 'ApprovalController@editapproval')->name('approval.editapproval');
                Route::put('/approval/approval/{id}', 'ApprovalController@updateapprove')->name('approval.updateapprove');
        ...
        // Route absensi
        // Route::resource('attendances', 'Admin\Attendance\AttendanceController');
        ...
        // Route Holiday_Allowance_Rule
        Route::get('/holidayallowancerule/read', 'Admin\HolidayAllowanceRuleController@read')->name('holidayallowancerule.read');
        Route::resource('/holidayallowancerule', 'Admin\HolidayAllowanceRuleController')->except(['show']);
        ...
        Route::post('/workingtime/multi', 'Admin\WorkingTimeController@multi')->name('workingtime.multi');
        ...
        Route::get('/salaryreportdetail/employeededuction', 'Admin\SalaryReportDetailController@employeededuction')->name('salaryreportdetail.employeededuction');
        ...
        //Route Answer
        Route::get('/question/read', 'Admin\QuestionController@read')->name('question.read');
        Route::get('/question/select', 'Admin\QuestionController@select')->name('question.select');
        Route::resource('/question', 'Admin\QuestionController');

        //Route Answer
        Route::get('/answer/read', 'Admin\AnswerController@read')->name('answer.read');
        Route::get('/answer/select', 'Admin\AnswerController@select')->name('answer.select');
        Route::resource('/answer', 'Admin\AnswerController');

        //Route Formula
        Route::get('/formula/read', 'Admin\FormulaController@read')->name('formula.read');
        // Route::get('/formula/select', 'Admin\AnswerController@select')->name('formula.select');
        Route::resource('/formula', 'Admin\FormulaController');

        // Kpi
        Route::get('/kpi/read', 'Admin\KpiController@read')->name('kpi.read');
        // Route::get('/kpi/select', 'Admin\KpiController@select')->name('kpi.select');
        Route::get('/kpi/draft', 'Admin\KpiController@draft')->name('kpi.draft');
        Route::post('/kpi/check', 'Admin\KpiController@check')->name('kpi.check');
        Route::post('/kpi/approvemass', 'Admin\KpiController@approvemass')->name('kpi.approvemass');
        Route::resource('/kpi', 'Admin\KpiController');

        // Kpi Approve
        Route::get('/kpiapproval/read', 'Admin\KpiResultController@read')->name('kpiapproval.read');
        Route::resource('/kpiapproval', 'Admin\KpiResultController');

        // Kpi Report
        Route::get('/kpireport/read', 'Admin\KpiReportController@read')->name('kpireport.read');
        Route::resource('/kpireport', 'Admin\KpiReportController');
        ...
        //Route Tenant
        Route::get('/tenant/read', 'Admin\TenantController@read')->name('tenant.read');
        Route::get('/tenant/select', 'Admin\TenantController@select')->name('tenant.select');
        Route::resource('/tenant', 'Admin\TenantController');
        //Route Room Category
        Route::get('/roomcategory/read', 'Admin\RoomCategoryController@read')->name('roomcategory.read');
        Route::get('/roomcategory/select', 'Admin\RoomCategoryController@select')->name('roomcategory.select');
        Route::resource('/roomcategory', 'Admin\RoomCategoryController');

        //Route Fasility
        Route::get('/fasility/read', 'Admin\FasilityController@read')->name('fasility.read');
        Route::get('/fasility/select', 'Admin\FasilityController@select')->name('fasility.select');
        Route::resource('/fasility', 'Admin\FasilityController');
        ...
        //Route Fasility
        Route::get('/transaction/read', 'Admin\TransactionController@read')->name('transaction.read');
        Route::get('/transaction/select', 'Admin\TransactionController@select')->name('transaction.select');
        Route::resource('/transaction', 'Admin\TransactionController');
        // Invoice
        Route::get('/invoice/read', 'Admin\InvoiceController@read')->name('invoice.read');
        Route::get('/invoice/{id}/addinvoice', 'Admin\InvoiceController@addinvoice')->name('invoice.addinvoice');
        Route::put('/invoice/saveinvoice/{id}', 'Admin\InvoiceController@saveinvoice')->name('invoice.saveinvoice');
        Route::get('/invoice/pdf/{id}', 'Admin\InvoiceController@pdf');
        Route::resource('invoice', 'Admin\InvoiceController');
        // Payment
        Route::get('/payment/read', 'Admin\PaymentController@read')->name('payment.read');
        Route::get('/payment/{id}/addpayment', 'Admin\PaymentController@addpayment')->name('payment.addpayment');
        Route::put('/payment/savepayment/{id}', 'Admin\PaymentController@savepayment')->name('payment.savepayment');
        Route::resource('payment', 'Admin\PaymentController');       

        Route::get('/paymentapproval/read', 'Admin\PaymentApprovalController@read')->name('paymentapproval.read');
        Route::get('/paymentapproval/{id}/editapproval', 'Admin\PaymentApprovalController@editapproval')->name('paymentapproval.editapproval');
        Route::put('/paymentapproval/approval/{id}', 'Admin\PaymentApprovalController@updateapprove')->name('paymentapproval.updateapprove');
        Route::resource('paymentapproval', 'Admin\PaymentApprovalController');

        //Route Checkin
        Route::get('/checkin/read', 'Admin\CheckinController@read')->name('checkin.read');
        Route::get('/checkin/{id}/addcheckin', 'Admin\CheckinController@addcheckin')->name('checkin.addcheckin');
        Route::put('/checkin/savecheckin/{id}', 'Admin\CheckinController@savecheckin')->name('checkin.savecheckin');
        Route::get('/checkin/select', 'Admin\CheckinController@select')->name('checkin.select');
        Route::resource('/checkin', 'Admin\CheckinController');

        //Route Checkout
        Route::get('/checkout/read', 'Admin\CheckoutController@read')->name('checkout.read');
        Route::get('/checkout/{id}/addcheckout', 'Admin\CheckoutController@addcheckout')->name('checkout.addcheckout');
        Route::put('/checkout/savecheckout/{id}', 'Admin\CheckoutController@savecheckout')->name('checkout.savecheckout');
        Route::get('/checkout/select', 'Admin\CheckinController@select')->name('checkout.select');
