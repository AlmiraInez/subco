...
class KpiReportController extends Controller
{
    ...
    {
        View::share('menu_active', url('admin/' . 'kpireport'));
    }
    /**
    ...
    public function index()
    {
        ...
        return view('admin.kpireport.index', compact('employees', 'departments', 'workgroups'));
    }

    public function read_1(Request $request)
    {
        $start          = $request->start;
        ...
        $query->where('kpi_results.status', 1);
