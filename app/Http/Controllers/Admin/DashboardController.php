...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $contracts = EmployeeContract::select('employee_id')->distinct()->where('end_date', '<=', $todata)->get()->count();
        ...
        return view('admin.dashboard', compact('roomavailable', 'leaves', 'contracts', 'documents', 'yesterdayAttendance', 'dayBeforeCount', 'dayBeforeNotCount', 'yesterdayAttendancebyDept', 'yesterdayOvertime', 'estimateSalary', 'grossSalaryYear', 'donutChart', 'estimateSalaryHourly'));
    }
